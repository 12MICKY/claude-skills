...
- **Example Calculation**: Controller IP = `10.33.1.34`
  - `10` = `0A`
  - `33` = `21`
  - `1`  = `01`
  - `34` = `22`
  - Result Payload = `0x01040a210122`
- **MikroTik RouterOS Config**:
  ```routeros
  /ip dhcp-server option add code=43 name=unifi-opt43 value=0x01040a210122
  /ip dhcp-server network set [find address=10.33.1.0/24] dhcp-option=unifi-opt43
  ```
